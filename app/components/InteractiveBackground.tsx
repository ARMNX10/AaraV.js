...
export default function InteractiveBackground() {
  ...
  return (
    <div ref={ref} className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
      ...
      <motion.div 
        className="absolute top-1/3 left-1/4 w-[600px] h-[400px] rounded-full bg-gradient-to-br from-blue-900/10 to-blue-600/5 blur-2xl"
        style={{
          x: x1,
          y: y1,
        }}
      ...
      <motion.div 
        className="absolute bottom-1/4 right-1/4 w-[500px] h-[300px] rounded-full bg-gradient-to-br from-purple-900/10 to-purple-600/5 blur-2xl"
        style={{
          x: x2,
          y: y2,
        }}
